...
public class CEItems {
  ...
  public static final Item WAXED_COPPER_HORSE_ARMOR = createItem("waxed_copper_horse_armor", new Item.Properties().horseArmor(CEArmorMaterials.WAXED_COPPER_ARMOR_MATERIAL));
  public static final Item WAXED_COPPER_NAUTILUS_ARMOR = createItem("waxed_copper_nautilus_armor", new Item.Properties().nautilusArmor(CEArmorMaterials.WAXED_COPPER_ARMOR_MATERIAL));
  ...
  public static final Item WAXED_EXPOSED_COPPER_HORSE_ARMOR = createItem("waxed_exposed_copper_horse_armor", new Item.Properties().horseArmor(CEArmorMaterials.WAXED_EXPOSED_COPPER_ARMOR_MATERIAL));
  public static final Item WAXED_EXPOSED_COPPER_NAUTILUS_ARMOR = createItem("waxed_exposed_copper_nautilus_armor", new Item.Properties().nautilusArmor(CEArmorMaterials.WAXED_EXPOSED_COPPER_ARMOR_MATERIAL));
  ...
  public static final Item WAXED_WEATHERED_COPPER_HORSE_ARMOR = createItem("waxed_weathered_copper_horse_armor", new Item.Properties().horseArmor(CEArmorMaterials.WAXED_WEATHERED_COPPER_ARMOR_MATERIAL));
  public static final Item WAXED_WEATHERED_COPPER_NAUTILUS_ARMOR = createItem("waxed_weathered_copper_nautilus_armor", new Item.Properties().nautilusArmor(CEArmorMaterials.WAXED_WEATHERED_COPPER_ARMOR_MATERIAL));
  ...
  public static final Item WAXED_OXIDIZED_COPPER_HORSE_ARMOR = createItem("waxed_oxidized_copper_horse_armor", new Item.Properties().horseArmor(CEArmorMaterials.WAXED_OXIDIZED_COPPER_ARMOR_MATERIAL));
  public static final Item WAXED_OXIDIZED_COPPER_NAUTILUS_ARMOR = createItem("waxed_oxidized_copper_nautilus_armor", new Item.Properties().nautilusArmor(CEArmorMaterials.WAXED_OXIDIZED_COPPER_ARMOR_MATERIAL));
  ...
  public static final Item EXPOSED_COPPER_HORSE_ARMOR = createItem("exposed_copper_horse_armor", new Item.Properties().horseArmor(CEArmorMaterials.EXPOSED_COPPER_ARMOR_MATERIAL));
  public static final Item EXPOSED_COPPER_NAUTILUS_ARMOR = createItem("exposed_copper_nautilus_armor", new Item.Properties().nautilusArmor(CEArmorMaterials.EXPOSED_COPPER_ARMOR_MATERIAL));
  ...
  public static final Item WEATHERED_COPPER_HORSE_ARMOR = createItem("weathered_copper_horse_armor", new Item.Properties().horseArmor(CEArmorMaterials.WEATHERED_COPPER_ARMOR_MATERIAL));
  public static final Item WEATHERED_COPPER_NAUTILUS_ARMOR = createItem("weathered_copper_nautilus_armor", new Item.Properties().nautilusArmor(CEArmorMaterials.WEATHERED_COPPER_ARMOR_MATERIAL));
  ...
  public static final Item OXIDIZED_COPPER_HORSE_ARMOR = createItem("oxidized_copper_horse_armor", new Item.Properties().horseArmor(CEArmorMaterials.OXIDIZED_COPPER_ARMOR_MATERIAL));
  public static final Item OXIDIZED_COPPER_NAUTILUS_ARMOR = createItem("oxidized_copper_nautilus_armor", new Item.Properties().nautilusArmor(CEArmorMaterials.OXIDIZED_COPPER_ARMOR_MATERIAL));
  ...
  public static final Item WAXED_COPPER_SPEAR = createItem("waxed_copper_spear", new Item.Properties().spear(CEToolMaterials.WAXED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F));
  ...
  public static final Item WAXED_EXPOSED_COPPER_SPEAR = createItem("waxed_exposed_copper_spear", new Item.Properties().spear(CEToolMaterials.WAXED_EXPOSED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F));
  ...
  public static final Item WAXED_WEATHERED_COPPER_SPEAR = createItem("waxed_weathered_copper_spear", new Item.Properties().spear(CEToolMaterials.WAXED_WEATHERED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F));
  ...
  public static final Item WAXED_OXIDIZED_COPPER_SPEAR = createItem("waxed_oxidized_copper_spear", new Item.Properties().spear(CEToolMaterials.WAXED_OXIDIZED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F));
  ...
  public static final Item EXPOSED_COPPER_SPEAR = createItem("exposed_copper_spear", new Item.Properties().spear(CEToolMaterials.EXPOSED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F));
  ...
  public static final Item WEATHERED_COPPER_SPEAR = createItem("weathered_copper_spear", new Item.Properties().spear(CEToolMaterials.WEATHERED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F));
  ...
  public static final Item OXIDIZED_COPPER_SPEAR = createItem("oxidized_copper_spear", new Item.Properties().spear(CEToolMaterials.OXIDIZED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F));
    ...
    ItemGroupEvents.modifyEntriesEvent(CreativeModeTabs.COMBAT).register((group) -> {
      ...
      group.addAfter(
              ...
              EXPOSED_COPPER_HORSE_ARMOR, WEATHERED_COPPER_HORSE_ARMOR, OXIDIZED_COPPER_HORSE_ARMOR,
      ...
      group.addAfter(
              ...
              EXPOSED_COPPER_NAUTILUS_ARMOR, WEATHERED_COPPER_NAUTILUS_ARMOR, OXIDIZED_COPPER_NAUTILUS_ARMOR,
              WAXED_COPPER_NAUTILUS_ARMOR, WAXED_EXPOSED_COPPER_NAUTILUS_ARMOR, WAXED_WEATHERED_COPPER_NAUTILUS_ARMOR, WAXED_OXIDIZED_COPPER_NAUTILUS_ARMOR
      );
      group.addAfter(
              Items.COPPER_SPEAR,
              EXPOSED_COPPER_SPEAR, WEATHERED_COPPER_SPEAR, OXIDIZED_COPPER_SPEAR,
              WAXED_COPPER_SPEAR, WAXED_EXPOSED_COPPER_SPEAR, WAXED_WEATHERED_COPPER_SPEAR, WAXED_OXIDIZED_COPPER_SPEAR
      );
    });
