...
public class CELightningEffectProvider extends LightningEffectProvider {
  ...
  protected void generate(BiConsumer<Identifier, LightningEffectBuilder> consumer) {
    ...
    lightningEffect(consumer, CEItems.EXPOSED_COPPER_HORSE_ARMOR, new MobEffectInstance(MobEffects.SPEED, 480, 0));
    lightningEffect(consumer, CEItems.EXPOSED_COPPER_NAUTILUS_ARMOR, new MobEffectInstance(MobEffects.SPEED, 480, 0));
    ...
    lightningEffect(consumer, CEItems.WEATHERED_COPPER_HORSE_ARMOR, new MobEffectInstance(MobEffects.RESISTANCE, 480, 0));
    lightningEffect(consumer, CEItems.WEATHERED_COPPER_NAUTILUS_ARMOR, new MobEffectInstance(MobEffects.RESISTANCE, 480, 0));
    ...
    lightningEffect(consumer, CEItems.WAXED_COPPER_HORSE_ARMOR, new MobEffectInstance(MobEffects.HASTE, 480, 1));
    lightningEffect(consumer, CEItems.WAXED_COPPER_NAUTILUS_ARMOR, new MobEffectInstance(MobEffects.HASTE, 480, 1));
    ...
    lightningEffect(consumer, CEItems.WAXED_EXPOSED_COPPER_HORSE_ARMOR, new MobEffectInstance(MobEffects.SPEED, 480, 1));
    lightningEffect(consumer, CEItems.WAXED_EXPOSED_COPPER_NAUTILUS_ARMOR, new MobEffectInstance(MobEffects.SPEED, 480, 1));
    ...
    lightningEffect(consumer, CEItems.WAXED_WEATHERED_COPPER_HORSE_ARMOR, new MobEffectInstance(MobEffects.RESISTANCE, 480, 1));
    lightningEffect(consumer, CEItems.WAXED_WEATHERED_COPPER_NAUTILUS_ARMOR, new MobEffectInstance(MobEffects.RESISTANCE, 480, 1));
    ...
    lightningEffect(consumer, CEItems.WAXED_OXIDIZED_COPPER_HORSE_ARMOR, new MobEffectInstance(MobEffects.WATER_BREATHING, 480, 1));
    lightningEffect(consumer, CEItems.WAXED_OXIDIZED_COPPER_NAUTILUS_ARMOR, new MobEffectInstance(MobEffects.WATER_BREATHING, 480, 1));
  }
}
