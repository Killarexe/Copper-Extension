...
public class CEWaxingProvider extends WaxingTransformationProvider {
  ...
  protected void generate(BiConsumer<Identifier, WaxingTransformationBuilder> consumer) {
    ...
    waxing(consumer, Items.COPPER_HORSE_ARMOR, WAXED_COPPER_HORSE_ARMOR);
    waxing(consumer, Items.COPPER_NAUTILUS_ARMOR, WAXED_COPPER_NAUTILUS_ARMOR);
    ...
    waxing(consumer, EXPOSED_COPPER_HORSE_ARMOR, WAXED_EXPOSED_COPPER_HORSE_ARMOR);
    waxing(consumer, EXPOSED_COPPER_NAUTILUS_ARMOR, WAXED_EXPOSED_COPPER_NAUTILUS_ARMOR);
    ...
    waxing(consumer, WEATHERED_COPPER_HORSE_ARMOR, WAXED_WEATHERED_COPPER_HORSE_ARMOR);
    waxing(consumer, WEATHERED_COPPER_NAUTILUS_ARMOR, WAXED_WEATHERED_COPPER_NAUTILUS_ARMOR);
    ...
    waxing(consumer, OXIDIZED_COPPER_HORSE_ARMOR, WAXED_OXIDIZED_COPPER_HORSE_ARMOR);
    waxing(consumer, OXIDIZED_COPPER_NAUTILUS_ARMOR, WAXED_OXIDIZED_COPPER_NAUTILUS_ARMOR);
    ...
    waxing(consumer, Items.COPPER_SPEAR, WAXED_COPPER_SPEAR);
    ...
    waxing(consumer, EXPOSED_COPPER_SPEAR, WAXED_EXPOSED_COPPER_SPEAR);
    ...
    waxing(consumer, WEATHERED_COPPER_SPEAR, WAXED_WEATHERED_COPPER_SPEAR);
    ...
    waxing(consumer, OXIDIZED_COPPER_SPEAR, WAXED_OXIDIZED_COPPER_SPEAR);
  }
}
