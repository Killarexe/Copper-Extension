  ...
  private static void addAfter(BuildCreativeModeTabContentsEvent event, ItemLike existing, Supplier<Item>... items) {
    ...
    if (event.getTabKey() == CreativeModeTabs.INGREDIENTS) {
      ...
      addAfter(
              ...
              CEItems.EXPOSED_COPPER_HORSE_ARMOR, CEItems.WEATHERED_COPPER_HORSE_ARMOR, CEItems.OXIDIZED_COPPER_HORSE_ARMOR,
              CEItems.WAXED_COPPER_HORSE_ARMOR, CEItems.WAXED_EXPOSED_COPPER_HORSE_ARMOR, CEItems.WAXED_WEATHERED_COPPER_HORSE_ARMOR, CEItems.WAXED_OXIDIZED_COPPER_HORSE_ARMOR
      );
      addAfter(
              event,
              Items.COPPER_NAUTILUS_ARMOR,
              CEItems.EXPOSED_COPPER_NAUTILUS_ARMOR, CEItems.WEATHERED_COPPER_NAUTILUS_ARMOR, CEItems.OXIDIZED_COPPER_NAUTILUS_ARMOR,
              CEItems.WAXED_COPPER_NAUTILUS_ARMOR, CEItems.WAXED_EXPOSED_COPPER_NAUTILUS_ARMOR, CEItems.WAXED_WEATHERED_COPPER_NAUTILUS_ARMOR, CEItems.WAXED_OXIDIZED_COPPER_NAUTILUS_ARMOR
      );
      addAfter(
              event,
              Items.COPPER_SPEAR,
              CEItems.EXPOSED_COPPER_SPEAR, CEItems.WEATHERED_COPPER_SPEAR, CEItems.OXIDIZED_COPPER_SPEAR,
              CEItems.WAXED_COPPER_SPEAR, CEItems.WAXED_EXPOSED_COPPER_SPEAR, CEItems.WAXED_WEATHERED_COPPER_SPEAR, CEItems.WAXED_OXIDIZED_COPPER_SPEAR
      );
