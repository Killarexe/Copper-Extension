...
public class CEItems {
  ...
  public static final Supplier<Item> WAXED_COPPER_HORSE_ARMOR = ITEMS.registerItem("waxed_copper_horse_armor", props -> new Item(props.horseArmor(CEArmorMaterials.WAXED_COPPER_ARMOR_MATERIAL)));
  public static final Supplier<Item> WAXED_COPPER_NAUTILUS_ARMOR = ITEMS.registerItem("waxed_copper_nautilus_armor", props -> new Item(props.nautilusArmor(CEArmorMaterials.WAXED_COPPER_ARMOR_MATERIAL)));
  ...
  public static final Supplier<Item> WAXED_EXPOSED_COPPER_HORSE_ARMOR = ITEMS.registerItem("waxed_exposed_copper_horse_armor", props -> new Item(props.horseArmor(CEArmorMaterials.WAXED_EXPOSED_COPPER_ARMOR_MATERIAL)));
  public static final Supplier<Item> WAXED_EXPOSED_COPPER_NAUTILUS_ARMOR = ITEMS.registerItem("waxed_exposed_copper_nautilus_armor", props -> new Item(props.nautilusArmor(CEArmorMaterials.WAXED_EXPOSED_COPPER_ARMOR_MATERIAL)));
  ...
  public static final Supplier<Item> WAXED_WEATHERED_COPPER_HORSE_ARMOR = ITEMS.registerItem("waxed_weathered_copper_horse_armor", props -> new Item(props.horseArmor(CEArmorMaterials.WAXED_WEATHERED_COPPER_ARMOR_MATERIAL)));
  public static final Supplier<Item> WAXED_WEATHERED_COPPER_NAUTILUS_ARMOR = ITEMS.registerItem("waxed_weathered_copper_nautilus_armor", props -> new Item(props.nautilusArmor(CEArmorMaterials.WAXED_WEATHERED_COPPER_ARMOR_MATERIAL)));
  ...
  public static final Supplier<Item> WAXED_OXIDIZED_COPPER_HORSE_ARMOR = ITEMS.registerItem("waxed_oxidized_copper_horse_armor", props -> new Item(props.horseArmor(CEArmorMaterials.WAXED_OXIDIZED_COPPER_ARMOR_MATERIAL)));
  public static final Supplier<Item> WAXED_OXIDIZED_COPPER_NAUTILUS_ARMOR = ITEMS.registerItem("waxed_oxidized_copper_nautilus_armor", props -> new Item(props.nautilusArmor(CEArmorMaterials.WAXED_OXIDIZED_COPPER_ARMOR_MATERIAL)));
  ...
  public static final Supplier<Item> EXPOSED_COPPER_HORSE_ARMOR = ITEMS.registerItem("exposed_copper_horse_armor", props -> new Item(props.horseArmor(CEArmorMaterials.EXPOSED_COPPER_ARMOR_MATERIAL)));
  public static final Supplier<Item> EXPOSED_COPPER_NAUTILUS_ARMOR = ITEMS.registerItem("exposed_copper_nautilus_armor", props -> new Item(props.nautilusArmor(CEArmorMaterials.EXPOSED_COPPER_ARMOR_MATERIAL)));
  ...
  public static final Supplier<Item> WEATHERED_COPPER_HORSE_ARMOR = ITEMS.registerItem("weathered_copper_horse_armor", props -> new Item(props.horseArmor(CEArmorMaterials.WEATHERED_COPPER_ARMOR_MATERIAL)));
  public static final Supplier<Item> WEATHERED_COPPER_NAUTILUS_ARMOR = ITEMS.registerItem("weathered_copper_nautilus_armor", props -> new Item(props.nautilusArmor(CEArmorMaterials.WEATHERED_COPPER_ARMOR_MATERIAL)));
  ...
  public static final Supplier<Item> OXIDIZED_COPPER_HORSE_ARMOR = ITEMS.registerItem("oxidized_copper_horse_armor", props -> new Item(props.horseArmor(CEArmorMaterials.OXIDIZED_COPPER_ARMOR_MATERIAL)));
  public static final Supplier<Item> OXIDIZED_COPPER_NAUTILUS_ARMOR = ITEMS.registerItem("oxidized_copper_nautilus_armor", props -> new Item(props.nautilusArmor(CEArmorMaterials.OXIDIZED_COPPER_ARMOR_MATERIAL)));
  ...
  public static final Supplier<Item> WAXED_COPPER_SPEAR = ITEMS.registerItem("waxed_copper_spear", props -> new Item(props.spear(CEToolMaterials.WAXED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F)));
  ...
  public static final Supplier<Item> WAXED_EXPOSED_COPPER_SPEAR = ITEMS.registerItem("waxed_exposed_copper_spear", props -> new Item(props.spear(CEToolMaterials.WAXED_EXPOSED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F)));
  ...
  public static final Supplier<Item> WAXED_WEATHERED_COPPER_SPEAR = ITEMS.registerItem("waxed_weathered_copper_spear", props -> new Item(props.spear(CEToolMaterials.WAXED_WEATHERED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F)));
  ...
  public static final Supplier<Item> WAXED_OXIDIZED_COPPER_SPEAR = ITEMS.registerItem("waxed_oxidized_copper_spear", props -> new Item(props.spear(CEToolMaterials.WAXED_OXIDIZED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F)));
  ...
  public static final Supplier<Item> EXPOSED_COPPER_SPEAR = ITEMS.registerItem("exposed_copper_spear", props -> new Item(props.spear(CEToolMaterials.EXPOSED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F)));
  ...
  public static final Supplier<Item> WEATHERED_COPPER_SPEAR = ITEMS.registerItem("weathered_copper_spear", props -> new Item(props.spear(CEToolMaterials.WEATHERED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F)));
  ...
  public static final Supplier<Item> OXIDIZED_COPPER_SPEAR = ITEMS.registerItem("oxidized_copper_spear", props -> new Item(props.spear(CEToolMaterials.OXIDIZED_COPPER_MATERIAL, 0.85F, 0.82F, 0.65F, 4.0F, 9.0F, 8.25F, 5.1F, 12.5F, 4.6F)));
}
